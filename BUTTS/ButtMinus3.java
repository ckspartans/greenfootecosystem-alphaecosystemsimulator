 ...
 */
public class ButtMinus3 extends Actor    
{
    /**
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this)){
            world.plantValue -= world.plantIncrease;
        }
    }
    /*
    public void act() 
    ...
    if (mouseHeld == true){
    //at start, if left clicked the butt dissapears
    for(int i = 0; i < 5; i++){
    getWorld().removeObject(plants.get(i));//takes object
