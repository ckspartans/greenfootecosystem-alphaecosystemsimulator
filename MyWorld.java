...
public class MyWorld extends World
{
    ...
    static public ArrayList <Algae> plants = new ArrayList<Algae> ();
    static public ArrayList <PlantEater> herbivores = new ArrayList<PlantEater> ();
    static public ArrayList <MeatEater> carnivores = new ArrayList<MeatEater> ();
    static public ArrayList <AnythingEater> omnivores = new ArrayList<AnythingEater> ();
    /**
